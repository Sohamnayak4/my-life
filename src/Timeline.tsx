...
const timelineData = [
    ...
    },
    {
        ...
        description: "Move to the nearest city.",
        details: "After a lot of struggle and tough decisions, my family decided to move to the nearest city from our small village for better opportunities for me and my brother.",
        status: "g",
    },
    {
        year: "2007",
    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center py-12">
      ...
      <div className="relative w-full max-w-2xl">
        ...
        {timelineData.map((event, index) => {
          ...
          const dotColor = isGreen ? "text-green-500 drop-shadow-[0_0_12px_rgba(34,197,94,1)]" : "text-red-500 drop-shadow-[0_0_12px_rgba(239,68,68,1)]";
          ...
          return (
            <motion.div
              key={index}
              className={`flex items-center justify-${isLeft ? "start" : "end"} my-6 relative`}
            ...
            >
              <div className="w-1/2 flex justify-end pr-4">
                {isLeft && (
                  ...
                  >
                    <h2 className={`text-xl font-semibold ${textColor}`}>{event.title}</h2>
              ...
              {hoveredEvent === index && (
                <motion.div 
                  className={`absolute top-1/2 transform -translate-y-1/2 ${isLeft ? "right-full mr-4" : "left-full ml-4"} bg-gray-800 p-4 rounded-lg shadow-lg w-64 text-gray-300 border border-gray-600 before:content-[''] before:absolute before:w-0 before:h-0 before:border-8 before:border-transparent before:top-1/2 before:-translate-y-1/2 ${isLeft ? "before:left-full before:border-l-gray-800" : "before:right-full before:border-r-gray-800"}`}
